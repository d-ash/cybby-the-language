...
This is a quick prototype of a toy language interpreter, written for NodeJs. It consists of a parser and a simple execution machine. There are no tests, and the execution machine has only a small subset of functions (arithmetics and output).
